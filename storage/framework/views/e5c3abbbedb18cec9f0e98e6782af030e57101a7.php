<?php $__env->startSection('title', 'Update Document '); ?>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                     <label for="zipcode" class="bmd-label-floating"></label>
                      <div class="col-xs-10">
                        <input type="checkbox" id="is_expiredate" name="is_expiredate" value="1" <?php echo e(($document->is_expiredate==1)?'checked="checked"':""); ?>>
                        <label for="is_expiredate"> <?php echo app('translator')->getFromJson('admin.document.document_isexpiredate'); ?></label>
                    </div>
                </div>
