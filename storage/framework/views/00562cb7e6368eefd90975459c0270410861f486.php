          ...
          <div class="modal-body">
            <div class="row no-margin" id="card-payment">
                ...
                <div class="form-group col-md-12 col-sm-12">
                    ...
                    <input data-stripe="name" autocomplete="off" required type="text" class="form-control" placehold="<?php echo app('translator')->getFromJson('provider.card.fullname'); ?>">
                </div>
                <div class="form-group col-md-12 col-sm-12">
                    <label><?php echo app('translator')->getFromJson('provider.card.card_no'); ?></label>
                    <input data-stripe="number" type="text" onkeypress="return isNumberKey(event);" required autocomplete="off" maxlength="16" class="form-control" placehold="<?php echo app('translator')->getFromJson('provider.card.card_no'); ?>">
                </div>
                ...
                <div class="form-group col-md-4 col-sm-12">
                    ...
                    <input type="text" data-stripe="cvc" onkeypress="return isNumberKey(event);" required autocomplete="off" maxlength="4" class="form-control" placehold="<?php echo app('translator')->getFromJson('provider.card.cvv'); ?>">
                </div>
            </div>
          </div>
