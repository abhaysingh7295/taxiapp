<?php $__env->startSection('title', 'Booking Issues Type '); ?>

<?php $__env->startSection('content'); ?>

            <div class="card">
                <div class="card-header card-header-primary">
                    <h5 class="card-title"><?php echo app('translator')->getFromJson('admin.bookingissue.title'); ?></h5>
                ...
                <a href="<?php echo e(route('admin.bookingissuetypes.create')); ?>" style="margin-left: 1em;" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> <?php echo app('translator')->getFromJson('admin.bookingissue.add_dispute'); ?></a>
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo app('translator')->getFromJson('admin.bookingissue.dispute_type'); ?> </th>
                            <th><?php echo app('translator')->getFromJson('admin.bookingissue.dispute_name'); ?> </th>                             
                            <th><?php echo app('translator')->getFromJson('admin.status'); ?></th>                         
                            <th><?php echo app('translator')->getFromJson('admin.action'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php $__currentLoopData = $bookingissuestype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $dist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <form action="<?php echo e(route('admin.bookingissuetypes.destroy', $dist->id)); ?>" method="POST">
                                    <?php echo e(csrf_field()); ?>

                                    <input type="hidden" name="_method" value="DELETE">
                                    <?php if( Setting::get('demo_mode', 0) == 0): ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('dispute-edit')): ?>
                                    <a href="<?php echo e(route('admin.bookingissuetypes.edit', $dist->id)); ?>" class="btn btn-info"><i class="fa fa-pencil"></i> <?php echo app('translator')->getFromJson('admin.edit'); ?></a>
                                    <?php endif; ?>
