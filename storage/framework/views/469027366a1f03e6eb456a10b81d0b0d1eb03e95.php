<?php $__env->startSection('title', 'Update Cities'); ?>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header card-header-primary">
                <h4 class="card-title pull-left">Update Cities</h4>
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('admin.city.update', $cities->id )); ?>" method="POST" enctype="multipart/form-data" role="form">
          ...
          <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            <select id="country" name="country" class="form-control" required>
                                ...
                                <option value="<?php echo e($key); ?>" <?php echo e(( $key == $cities->country_id) ? 'selected' : ''); ?>> <?php echo e($country); ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            <input class="form-control" type="text" value="<?php echo e($cities->name); ?>" name="name" required id="name">
                        </div>
                    </div>
                    <div class="form-group">
