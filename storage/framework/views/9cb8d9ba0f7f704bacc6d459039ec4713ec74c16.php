<?php $__env->startSection('title', 'Add Booking Issues Type'); ?>

<?php $__env->startSection('content'); ?>

        <div class="card">
            <div class="card-header card-header-primary">
                <h5 class="card-title" style="margin-bottom: 2em;"><?php echo app('translator')->getFromJson('admin.bookingissue.add_dispute'); ?></h5>
            ...
            <form class="form-horizontal" action="<?php echo e(route('admin.bookingissuetypes.store')); ?>" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" autocomplete="off"  type="text" value="<?php echo e(old('name')); ?>" name="name" required id="name" placehold="<?php echo app('translator')->getFromJson('admin.bookingissue.dispute_name'); ?>">
                    </div>
                </div>

                <div class="form-group">
                    <label for="dispute_status" class="bmd-label-floating"><?php echo app('translator')->getFromJson('admin.bookingissue.dispute_status'); ?></label>
                    <div class="col-xs-10">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-10">
                        <button type="submit" class="btn btn-primary"><?php echo app('translator')->getFromJson('admin.bookingissue.add_dispute'); ?></button>
