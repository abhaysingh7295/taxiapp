...
<?php $__env->startSection('content'); ?>
              ...
              <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="card-header card-header-info card-header-icon">
                        ...
                        <p class="card-category"><?php echo app('translator')->getFromJson('admin.dashboard.drivers_online'); ?></p>
                        <h3 class="card-title">
                            <?php echo e($provider_online); ?>
               ...
               <div class="row">
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('dashboard-menus')): ?>
                 <div class="col">
                    ...
                    <div class="card-header card-header-default card-header-icon">
                        ...
                        <p class="card-category"><?php echo app('translator')->getFromJson('admin.dashboard.drivers_orange_flagged_drivers'); ?></p>
                        <h3 class="card-title"><?php echo e($provider_orangeflag); ?></h3>
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="card-header card-header-primary card-header-icon">
                        ...
                        <p class="card-category"><?php echo app('translator')->getFromJson('admin.dashboard.drivers_red_flagged_drivers'); ?></p>
                        <h3 class="card-title"><?php echo e($provider_redflag); ?></h3>
                    </div>
                    </div>
                </div>
            ...
            <div class="row">
                    ...
                    <div class="card-header card-header-info card-header-icon">
                        ...
                        <p class="card-category"><?php echo app('translator')->getFromJson('admin.dashboard.driver_approved'); ?></p>
                        <h3 class="card-title">
                            <?php echo e($provider_approved); ?>
                ...
                <div class="col">
                    ...
                    <div class="card-header card-header-default card-header-icon">
                        ...
                        <p class="card-category"><?php echo app('translator')->getFromJson('admin.dashboard.drivers_unapproved'); ?></p>
                        <h3 class="card-title"><?php echo e($provider_unapproved); ?></h3>
                    </div>
