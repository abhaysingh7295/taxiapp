                        ...
                        <form class="profile-form" action="<?php echo e(route('provider.profile.update')); ?>" method="POST" enctype="multipart/form-data" role="form">
                                ...
                                <div class="row no-margin">
                                    <div class="prof-sub-col col-sm-6 col-xs-12 no-left-padding">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placehold="<?php echo app('translator')->getFromJson('provider.profile.first_name'); ?>" name="first_name" value="<?php echo e(Auth::guard('provider')->user()->first_name); ?>" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="<?php echo app('translator')->getFromJson('provider.profile.first_name'); ?> <?php echo app('translator')->getFromJson('provider.profile.error_msg'); ?>">
                                        </div>
                                    </div>
                            ...
                            <div class="prof-form-sub-sec border-top">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placehold="<?php echo app('translator')->getFromJson('provider.profile.address'); ?>" name="address" value="<?php echo e(Auth::guard('provider')->user()->profile ? Auth::guard('provider')->user()->profile->address : ""); ?>">
                                    <input type="text" class="form-control" placehold="<?php echo app('translator')->getFromJson('provider.profile.full_address'); ?>" style="border-top: none;" name="address_secondary" value="<?php echo e(Auth::guard('provider')->user()->profile ? Auth::guard('provider')->user()->profile->address_secondary : ""); ?>">
                                </div>
                                ...
                                <div class="row no-margin">
                                    <!-- <div class="prof-sub-col col-sm-6 col-xs-12 no-left-padding">
                                        <div class="form-group no-margin">
                                            ...
                                            <input type="text" class="form-control" placehold="<?php echo app('translator')->getFromJson('provider.profile.pin'); ?>" name="postal_code" value="<?php echo e(Auth::guard('provider')->user()->profile ? Auth::guard('provider')->user()->profile->postal_code : ""); ?>">
                                        </div>
                                    </div> -->
                                    <div class="prof-sub-col col-sm-6 col-xs-12 no-left-padding">
                                        <div class="form-group">
