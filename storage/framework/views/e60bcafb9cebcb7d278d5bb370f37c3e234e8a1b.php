        ...
        <div class="card">
            ...
            <form class="form-horizontal" action="<?php echo e(route('admin.role.update', $role->id )); ?>" method="POST" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="text" value="<?php echo e($role->name); ?>" name="name" required id="name" placehold="<?php echo app('translator')->getFromJson('admin.name'); ?>" readonly="readonly">
                    </div>
                </div>
