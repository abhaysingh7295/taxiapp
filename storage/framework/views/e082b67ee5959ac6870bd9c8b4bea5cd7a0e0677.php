    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('admin.company.store')); ?>" method="POST" enctype="multipart/form-data" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            <input class="form-control" type="email" value="<?php echo e(old('email')); ?>" name="email" required id="email">
                        </div>
                    </div>
                      <div class="form-group">
                        <label for="address" class="bmd-label-floating">Address</label>
                        <div class="col-xs-10">
                            <input class="form-control" type="text" value="<?php echo e(old('address')); ?>" name="address" required id="address">
                        </div>
                    </div>
                       <div class="form-group">
                        <label for="phone" class="bmd-label-floating">Phone</label>
                        <div class="col-xs-10">
                            <input class="form-control" type="number" min="1" maxlength="10" value="<?php echo e(old('phone')); ?>" name="phone" required id="phone">
                        </div>
                    </div>
                    <div class="form-group">
