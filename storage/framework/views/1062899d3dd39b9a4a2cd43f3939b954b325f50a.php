        ...
        <div class="row no-margin edit-pro">
            ...
            <?php echo e(csrf_field()); ?>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="first_name" required placehold="<?php echo app('translator')->getFromJson('user.profile.first_name'); ?>" value="<?php echo e(Auth::user()->first_name); ?>" data-validation="alphanumeric" data-validation-allowing=" -" data-validation-error-msg="First Name can only contain alphanumeric characters and . - spaces">
                </div>
                <div class="form-group col-md-6">
                    <label><?php echo app('translator')->getFromJson('user.profile.last_name'); ?></label>
                    <input type="text" class="form-control" name="last_name" required placehold="<?php echo app('translator')->getFromJson('user.profile.last_name'); ?>" value="<?php echo e(Auth::user()->last_name); ?>" data-validation-allowing=" -" data-validation-error-msg="Last Name can only contain alphanumeric characters and . - spaces">
                </div>

                <div class="form-group col-md-12">
                    <label><?php echo app('translator')->getFromJson('user.profile.email'); ?></label>
                    <input type="email" class="form-control" placehold="<?php echo app('translator')->getFromJson('user.profile.email'); ?>" readonly value="<?php echo e(Auth::user()->email); ?>">
                </div>
                ...
                <div class="row no-margin">
                    <div class="prof-sub-col col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="phone_number" required placehold="Contact Number" name="mobile" value="<?php echo e(Auth::user()->mobile); ?>" data-validation="custom length" data-validation-length="10-15" data-validation-regexp="^([0-9\+]+)$" data-validation-error-msg="Incorrect phone number" disabled="disabled">
