<?php $__env->startSection('title', 'Complain Issues Type '); ?>
                ...
                <table class="table">
                    ...
                    <?php $__currentLoopData = $dispute; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $dist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php if($dist->dispute_type=='user'): ?><?php echo e(__('admin.user')); ?> <?php endif; ?> <?php if($dist->dispute_type=='provider'): ?><?php echo e(__('admin.provider')); ?> <?php endif; ?></td>
