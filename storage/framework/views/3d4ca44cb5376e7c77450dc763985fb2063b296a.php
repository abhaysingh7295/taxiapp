<?php $__env->startSection('title', 'Add Car Type'); ?>
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('admin.cartype.store')); ?>" method="POST" enctype="multipart/form-data" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            <input class="form-control" type="text" value="<?php echo e(old('description')); ?>" name="description" required id="description">
                        </div>
                    </div>
                    <div class="form-group">
