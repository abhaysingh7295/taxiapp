<?php $__env->startSection('title', 'Update Country'); ?>
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(route('admin.country.update', $countries->id )); ?>" method="POST" enctype="multipart/form-data" role="form">
         ...
         <input type="hidden" name="_method" value="PATCH">
                    <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            <input class="form-control" type="text" value="<?php echo e($countries->name); ?>" name="name" required id="name">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            ...
                            <a href="<?php echo e(route('admin.country.index')); ?>" class="btn btn-default"><?php echo app('translator')->getFromJson('admin.cancel'); ?></a>
                        </div>
                    </div>
                </form>
            </div>
