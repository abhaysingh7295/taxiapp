...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('admin.country.index')); ?>" method="get">
                <div class="form-group col-md-12" style="padding-left:0 !important; padding-right:0 !important; margin-bottom: 20px;">
                    ...
                    <div class="col-xs-3">
                        <a href="<?php echo e(route('admin.country.create')); ?>" style="margin-left: 1em;" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>Add New</a>
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $countrie; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php ($page++); ?>
                        <tr>
                            ...
                            <td>
                                <form action="<?php echo e(route('admin.country.destroy', $country->id)); ?>" method="POST">
                                    ...
                                    <a href="<?php echo e(route('admin.country.edit', $country->id)); ?>" class="btn btn-info"><i class="fa fa-pencil"></i> <?php echo app('translator')->getFromJson('admin.edit'); ?></a>
...
<script type="text/javascript">
    jQuery.fn.DataTable.Api.register('buttons.exportData()', function (options) {
        if (this.context.length) {
            var jsonResult = $.ajax({
                url: "<?php echo e(url('admin/countrie')); ?>?page=all",
                data: {},
