        ...
        <div class="card-body">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e(get_vehicle_makename($service->service_number)); ?></td>
                            <td><?php echo e(get_vehicle_modelname($service->service_number)); ?></td>
                            <td>
            ...
            <form action="<?php echo e(route('admin.provider.document.store', $Provider->id)); ?>" method="POST">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="from-group">
                            ...
                            <select class="form-control" name="service_type" required>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = get_all_service_types(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="col-md-6">
                        <div class="from-group">
                            <label for="service_number" class="bmd-label-floating">Vehicles</label>
                            <select class="form-control" name="service_number" required>
                                <option>- Select Vehicle -</option>
                                <?php $__empty_1 = true; $__currentLoopData = $vehicle; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $values): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <option value="<?php echo e($values->id); ?>"> <?php echo e($values->make); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
