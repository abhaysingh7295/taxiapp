    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('admin.city.update', $cities->id )}}" method="POST" enctype="multipart/form-data" role="form">
                    {{csrf_field()}}
          ...
          <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            <select id="country" name="country" class="form-control" required>
                                ...
                                <option value="{{$key}}" {{ ( $key == $cities->country_id) ? 'selected' : '' }}> {{$country}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            <input class="form-control" type="text" value="{{ $cities->name }}" name="name" required id="name">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="area" class="bmd-label-floating">Area</label>
                        <div class="col-xs-10">
                            <input class="form-control" type="number" value="{{ $cities->area }}" name="area" required id="area">
                        </div>
                    </div>
                    <div class="form-group">
