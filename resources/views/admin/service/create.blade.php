            ...
            <form class="form-horizontal" action="{{route('admin.service.store')}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <h3 style="color: White;font-size: 25px;">Intercity Trips</h3>
                    ...
                    <div class="form-group col">
                        ...
                        <input class="form-control" type="number" value="{{ old('intercitytripsamountdiscount') }}" name="intercitytripsamountdiscount" id="intercitytripsamountdiscount"  min="0">
                    </div>
                    
                    <div class=" form-group col">
                        <label for="intercitytripextracharges" class="col col-form-label">Extra Charges {{ currency() }}</label>
                        <input class="form-control" type="number" value="{{ old('intercitytripextracharges') }}" name="intercitytripextracharges" id="intercitytripextracharges"  min="0">
                    </div>
                </div>
                 <h3 style="color: White;font-size: 25px;">Scheduled Trips</h3>
                    ...
                    <div class="form-group col">
                        ...
                        <input class="form-control" type="number" value="{{ old('seheduletripamountdiscountwaitingtime') }}" name="seheduletripamountdiscountwaitingtime" id="seheduletripamountdiscountwaitingtime"  min="0">
                    </div>
