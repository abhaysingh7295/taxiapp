...
@section('title', 'Add Driver Fare Issues')
    ...
    <div class="container-fluid">
		<div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title pull-left">@lang('admin.driverfareissue.add_dispute')</h4>
                <a href="{{ URL::previous() }}" class="btn pull-right"><i
                    class="fa fa-angle-left"></i> @lang('admin.back')</a>
            </div>
            <div class="card-body">

            <form class="form-horizontal" action="{{route('admin.driverdisputestore')}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}

				<div class="form-group">
					<label for="user" class="bmd-label-floating">@lang('admin.driverfareissue.dispute_type')</label>
					<div class="col-xs-5">
				...
				<div class="form-group">
					<label for="user" class="bmd-label-floating"> @lang('admin.dispute.dispute_provider')</label>

					<div class="col-xs-5">
						<div class="input-group">
							<input class="form-control" type="text" value="{{ old('name') }}" name="name" id="namesearch" placehold="" required="" aria-describedby="basic-addon2" autocomplete="off">
					...
					<div class="col-xs-5">
		                ...
		                <table class="table">
		                    ...
		                    <tbody>
                                ...
                                <div class="form-group">
					<label for="lost_item_name" class="bmd-label-floating">@lang('admin.driverfareissue.dispute_reason')</label>
					<div class="col-xs-5">
				...
				<div class="form-group">
					<label for="lost_item_name" class="bmd-label-floating">@lang('admin.driverfareissue.dispute_name')</label>
					<div class="col-xs-5">
				...
				<div class="form-group">
					...
					<div class="col-xs-5">
						...
						<button type="submit" class="btn btn-primary">@lang('admin.driverfareissue.add_dispute')</button>
						<a href="{{route('admin.driverdisputes')}}" class="btn btn-default">@lang('admin.cancel')</a>
					</div>
				</div>
			</form>
		</div>
