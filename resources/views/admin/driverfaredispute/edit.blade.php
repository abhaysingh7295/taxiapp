...
@section('title', 'Edit Driver Fare Issues')
  ...
  display: table-cell;
    ...
    <div class="container-fluid">
		<div class="card">
            ...
            <div class="card-body">
            <form class="form-horizontal" action="{{route('admin.driverdisputeupdate',$dispute->id)}}" method="POST" enctype="multipart/form-data" role="form">
            	{{csrf_field()}}
