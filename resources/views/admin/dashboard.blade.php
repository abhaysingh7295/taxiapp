              ...
              <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="card-header card-header-info card-header-icon">
                        ...
                        <p class="card-category">@lang('admin.dashboard.drivers_online')</p>
                        <h3 class="card-title">
                            {{$provider_online}}
                ...
                <div class="col">
                    ...
                    <div class="card-header card-header-default card-header-icon">
                        ...
                        <p class="card-category">@lang('admin.dashboard.drivers_orange_flagged_drivers')</p>
                        <h3 class="card-title">{{$provider_orangeflag}}</h3>
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="card-header card-header-primary card-header-icon">
                        ...
                        <p class="card-category">@lang('admin.dashboard.drivers_red_flagged_drivers')</p>
                        <h3 class="card-title">{{$provider_redflag}}</h3>
                    </div>
                    </div>
                </div>
                @endcan
               ...
               <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="card-header card-header-info card-header-icon">
                        ...
                        <p class="card-category">@lang('admin.dashboard.driver_approved')</p>
                        <h3 class="card-title">
                            {{$provider_approved}}
                ...
                <div class="col">
                    ...
                    <div class="card-header card-header-default card-header-icon">
                        ...
                        <p class="card-category">@lang('admin.dashboard.drivers_unapproved')</p>
                        <h3 class="card-title">{{$provider_unapproved}}</h3>
                    </div>
