    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('admin.cartype.update', $cartype->id )}}" method="POST" enctype="multipart/form-data" role="form">
                    {{csrf_field()}}
         <input type="hidden" name="_method" value="PATCH">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            <input class="form-control" type="text" value="{{ $cartype->name }}" name="name" required id="name">
                        </div>
                    </div>
                     <div class="form-group">
                        <label for="description" class="bmd-label-floating">Description</label>
                        <div class="col-xs-10">
                            <input class="form-control" type="text" value="{{ $cartype->description }}" name="description" required id="description">
                        </div>
                    </div>
                    <div class="form-group">
