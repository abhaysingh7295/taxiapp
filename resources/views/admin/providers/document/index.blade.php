                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ get_vehicle_makename($service->service_number) }}</td>
                            <td>{{ get_vehicle_modelname($service->service_number) }}</td>
                            <td>
                    ...
                    <div class="col-md-3">
                        <div class="from-group">
                            ...
                            <select class="form-control" name="service_type" required>
                                ...
                                @forelse(get_all_service_types() as $Type)
                    ...
                    <div class="col-md-6">
                        <div class="from-group">
                            ...
                            <select class="form-control" name="service_number" required>
                                ...
                                @forelse($vehicle as $values)
                                <option value="{{ $values->id }}"> {{ $values->make }}</option>
                                @empty
