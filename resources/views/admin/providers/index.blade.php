                            ...
                            <td>
                                <div class="input-group-btn">
                                    ...
                                    <ul class="dropdown-menu">
                                        @can('driver-redflag')
                                        <li>
                                            @if($provider->is_red_flag == 0)
                                            <a href="{{ route('admin.provider.redflagon', $provider->id) }}"
                                        ...
                                        @endcan
                                        @can('driver-orangeflag')
                                        <li>
                                            @if($provider->is_orenge_flag == 0)
                                            <a href="{{ route('admin.provider.orangeflagon', $provider->id) }}"
                                               class="btn btn-default"><i style="color:orange;"
                                                                       class="fa fa-flag"></i> @lang('admin.provides.orangeflag')</a>
                                            @else
                                            <a href="{{ route('admin.provider.orangeflagoff', $provider->id) }}"
                                               class="btn btn-default"><i style="color:orange;"
                                                                       class="fa fa-flag"></i> @lang('admin.provides.orangeflagoff')</a>  @endif
                                        </li>
                                        @endcan
