...
<div class="form-group">
                        <label class="checkbox"><input type="radio" checked="checked" name="gender" value="MALE" data-validation="required" data-validation-error-msg="Please select a gender" {{  ($user->gender =='MALE' ? ' checked' : '') }}> Male</label>
                                    <label class="checkbox"><input type="radio" name="gender" value="FEMALE" data-validation-error-msg="Please select a gender" {{  ($user->gender =='FEMALE' ? ' checked' : '') }}> Female</label> 
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            <select name="city" id="city" class="form-control" required>
                                 @foreach(get_all_city($user->country) as $type)
