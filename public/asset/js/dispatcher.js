...
class DispatcherList extends React.Component {
    ...
    getTripsUpdate() {
        $.get('/taxiapp/public/dispatcher/dispatcher/trips', function(result) {
...
class DispatcherRequest extends React.Component {
    ...
    componentDidMount() {
        ...
        $.get('/taxiapp/public/dispatcher/service', function(result) {
            this.setState({
                data: result
            });
        }.bind(this));
    ...
    createRide(event) {
        ...
        $.ajax({
            url: '/taxiapp/public/dispatcher/dispatcher',
            dataType: 'json',
...
class DispatcherAssignList extends React.Component {
    ...
    componentDidMount() {
        $.get('/taxiapp/public/dispatcher/dispatcher/providers', { 
    ...
    render() {
        ...
        return (
            <div className="card">
                <div className="card-header text-uppercase"><b>Assign Driver</b></div>
