...
//                }
                ...
                (new DocumentController)->documentupdate($images, $doc_id, $provider_id);
                ...
                exit();
                 ...
                 return response()->json(['error' => 'Invalid file type!!'], 400);                 exit();
            }
        } catch (Exception $e) {
            return response()->json(['error' => trans('api.something_went_wrong')], 501);
            exit();
        }
    }
