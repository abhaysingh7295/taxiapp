...
class AdminController extends Controller {
    ...
    public function dashboard(Request $request) {
        ...
        try {
            ...
            return view('admin.dashboard', compact('providers', 'provider', 'scheduled_rides', 'users', 'rides', 'totalRides', 'user_cancelled', 'provider_cancelled', 'cancel_rides', 'revenue', 'wallet','provider_approved','provider_banned','provider_unapproved','provider_onboarding','provider_approved','provider_online','provider_offline','provider_riding','provider_hold',''));
        } catch (Exception $e) {
